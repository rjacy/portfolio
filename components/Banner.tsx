        ...
        <div className="lg:w-[50%] flex flex-col gap-5 justify-center text-center items-center md:text-start md:items-start md:justify-start ">
          ...
          <div className="flex flex-col md:flex md:flex-row items-center gap-5">
            <Button className="bg-orange-500 hover:text-white text-darkmode text-lg font-medium px-10 py-7 rounded-2xl">
              <Link href="https://drive.google.com/file/d/1RgtNg8ySehLp2YmRiMQw8klmuXTGuH_J/view?usp=sharing" target="_blank">View CV/Resume</Link>
            </Button>
            <div className="flex gap-2">
              <Link href="https://linkedin.com/in/tmide" target="_blank">
                <svg
              ...
              <Link href="https://x.com/tonymiide" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
              ...
              <Link href="https://github.com/tmide" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  x="0px"
                  y="0px"
